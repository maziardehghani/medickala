        ...
        if (target.length > 0) {
            target.each(function () {
                var el = $(this),
                    ...
                    dataNavLeft = (el.data('owl-nav-left')) ? el.data('owl-nav-left') : "<i class='fa fa-chevron-right'></i>",
                    dataNavRight = (el.data('owl-nav-right')) ? el.data('owl-nav-right') : "<i class='fa fa-chevron-left'></i>",
    ...
    function slidePriceWidget() {
        ...
        if (rangeSlider) {
            ...
            rangeSlider.noUiSlider.on("update", function(values, handle) {
                inputs[handle].textContent  =  values[handle] + ' تومان ' ;
            });
        }
    }
