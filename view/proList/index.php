...
<?php
$category = $data['headCat'];
$underCat = $data['underCat'];
    ...
    <div class="ps-categogy">
        <div class="container">
            <ul class="ps-breadcrumb">
                ...
                <li class="ps-breadcrumb__item active" aria-current="page">تشخیص</li>
            </ul>
            <h1 class="ps-categogy__name">محصولات <sup>(32)</sup></h1>
            <div class="ps-categogy__content">
                <div class="row row-reverse">
                    <div class="col-12 col-md-9">
                        <div class="ps-categogy__wrapper">
                            <div class="ps-categogy__type"> <a class="active" href="category-list.html"><img src="<?= URL ?>img/icon/bars.svg" alt=""></a><a href="category-grid-detail.html"><img src="<?= URL ?>img/icon/gird2.svg" alt=""></a><a href="category-grid.html"><img src="<?= URL ?>img/icon/gird3.svg" alt=""></a><a href="category-grid-separate.html"><img src="<?= URL ?>img/icon/gird4.svg" alt=""></a></div>
                            <div class="ps-categogy__onsale">
                                <form>
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="onSaleProduct">
                                        <label class="custom-control-label" for="onSaleProduct">فقط محصولات در حال فروش را نمایش دهید</label>
                                    </div>
                                </form>
                            </div>
                            <div class="ps-categogy__sort">
                                <form><span>مرتب سازی بر اساس</span>
                                    <select class="form-select">
                                        <option selected="">آخرین</option>
                                        <option value="Popularity">محبوبیت</option>
                                        <option value="Average rating">رتبه متوسط</option>
                                        <option value="Latest">آخرین</option>
                                        <option value="Price: low to high">قیمت: کم به زیاد</option>
                                        <option value="Price: high to low">قیمت: بالا به پایین</option>
                                    </select>
                                </form>
                            </div>
                            <div class="ps-categogy__show">
                                <form><span>نمایش</span>
                                    <select class="form-select">
                            ...
                            foreach ($products as $row)
                            {
                                ...
                                <div class="ps-product ps-product--list">
                                    <div class="ps-product__content">
                                        <div class="ps-product__thumbnail"><a class="ps-product__image" href="#">
                                            ...
                                            <div class="ps-product__actions">
                                                <div class="ps-product__item" data-toggle="tooltip" data-placement="left" title="مشاهده سریع"><a  data-toggle="modal" data-target="#popupQuickview"><i class="fa fa-search"></i></a></div>
                                            </div>
                                            <div class="ps-product__badge">
                                            </div>
                                        </div>
                                        <div class="ps-product__info"><a class="ps-product__branch">بازدید <?= $row['view'] ?></a>
                                            <h5 class="ps-product__title"><a><?= $row['title'] ?></a></h5>
                                            <div class="ps-product__rating">
                                                <span class="ps-product__review">(<?= $row['discount'] ?> % تخفیف )</span>
                                            </div>
                                    ...
                                    <div class="ps-product__footer">
                                        <div class="ps-product__meta"><span class="ps-product__price sale"> <?= $row['price'] ?> تومان</span><span class="ps-product__del"> </span>
                                        </div>
                                        <div class="ps-product__quantity">
                                            <div class="def-number-input number-input safari_only">
                                            </div><a class="ps-btn ps-btn--warning" href="<?= baseURL ?>product/index/<?= $row['id'] ?>">مشاهده</a>
                                        </div>
                        ...
                        <div class="ps-delivery" data-background="<?= URL ?>img/promotion/banner-delivery-2.jpg">
                    ...
                    <div class="col-12 col-md-3">
                        <div class="ps-widget ps-widget--product">
                            <div class="ps-widget__block">
                                <h4 class="ps-widget__title">دسته بندی ها</h4><a class="ps-block-control" href="#"><i class="fa fa-angle-down"></i></a>
                                <div class="ps-widget__content ps-widget__category">
                                    <ul class="menu--mobile">
                                        <?php
                                        foreach ($category as $row) {
                                            ?>
                                            <li><a><?= $row['title'] ?></a><span class="sub-toggle"><i class="fa fa-chevron-down"></i></span>
                                                <ul class="sub-menu">
                                                    <?php
                                                    foreach ($underCat as $item)
                                                    {
                                                        if ($item['parent']==$row['id'])
                                                        {
                                                            echo "<li><a href= '".baseURL."proList/index/".$item['id']."'>".$item['title']."</a></li>";
                                                        }
                                                        ?>
                                                        <?php
                                                    }
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="ps-footer--address">
                                    ...
                                    <p> <i class="icon-map-marker icon"></i>تهران - ونک - خیابان بهار</p>
                            ...
                            <div class="col-12 col-md-8">
                                <div class="ps-footer--contact">
                                    ...
                                    <div class="ps-footer__fax"> 09123456789  <i class="icon-telephone"></i></div>
                                    <p class="ps-footer__work">شنبه تا پنجشنبه:   9 الی 18</p>
                                    <hr>
                                    <p><a class="ps-footer__email" href="#"> <span class="__cf_email__">  needhelp@youdomain.com<i class="icon-envelope"></i></span> </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="ps-menu--slidebar">
    <div class="ps-menu__content">
        <ul class="menu--mobile">
            ...
            <li class="menu-item-has-children"><a href="category-list.html">دسته بندی</a></li>
