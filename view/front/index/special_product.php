...
<section class="ps-section--featured">
    ...
    <div class="ps-section__content">
        <div class="row m-0">
            <?php
            foreach($special_product as $special)
            {
            ...
            <div class="col-6 col-md-4 col-lg-2dot4 p-0">
                <div class="ps-section__product">
                    <div class="ps-product ps-product--standard">
                        <div class="ps-product__thumbnail"><a class="ps-product__image" href="<?= baseURL ?>product/index/<?= $special['id'] ?>">
                        ...
                        <div class="ps-product__content">
                            <h5 class="ps-product__title"><a href="<?= baseURL ?>product/index/<?= $special['id'] ?>"><?= $special['title'] ?></a></h5>
        ...
        <div class="ps-shop__more"><a href="#">نمایش همه</a></div>
    </div>
</section>
</div>